...
describe('RoomTypeCard', () => {
  describe('price display', () => {
    it('shows starting from text', () => {
      renderWithI18n(<RoomTypeCard {...DEFAULT_PROPS} />);
  ...
  describe('normal state', () => {
    ...
    it('shows Selected button when rate plan is already selected', () => {
      renderWithI18n(<RoomTypeCard {...DEFAULT_PROPS} selectedRatePlanId="rp-1" />);
      expect(screen.getByText('roomCard.selected')).toBeTruthy();
    });

    it('disables Select Room button when no dates provided', () => {
      renderWithI18n(<RoomTypeCard {...DEFAULT_PROPS} checkin={undefined} checkout={undefined} />);
    ...
    it('calls onRoomSelect with correct info when clicked', async () => {
      ...
      renderWithI18n(<RoomTypeCard {...DEFAULT_PROPS} onRoomSelect={onRoomSelect} />);
  ...
  describe('own active CART booking', () => {
    ...
    it('shows Booking in progress chip', () => {
      renderWithI18n(<RoomTypeCard {...ownCartProps} />);
