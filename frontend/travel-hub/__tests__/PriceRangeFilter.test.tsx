...
describe('PriceRangeFilter', () => {
  ...
  it('shows validation error when min > max on blur', () => {
    ...
    expect(screen.getByText('El precio mínimo no puede ser mayor al máximo')).toBeTruthy();
  ...
  it('clears error when input changes after validation error', () => {
    ...
    expect(screen.queryByText('El precio mínimo no puede ser mayor al máximo')).toBeNull();
  });
