...
-- ── Occupancy reporting: extend Cancún inventory beyond the default 30-day horizon ──
-- So GET /occupancy/projection (90 days) has inventory rows for Sol Caribe Cancún.
INSERT INTO catalog.inventory_calendar (id, room_type_id, day, available_units)
SELECT gen_random_uuid(), '60000000-0000-0000-0000-000000000001', d::date, 8
FROM generate_series(CURRENT_DATE + INTERVAL '30 days', CURRENT_DATE + INTERVAL '365 days', '1 day') AS d
WHERE NOT EXISTS (
  SELECT 1 FROM catalog.inventory_calendar ic
  WHERE ic.room_type_id = '60000000-0000-0000-0000-000000000001'
    AND ic.day = d::date
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM catalog.inventory_calendar ic
  WHERE ic.room_type_id = '60000000-0000-0000-0000-000000000002'
    AND ic.day = d::date
);

-- ── Occupancy demo (Sol Caribe Cancún): variar inventario + reservas CONFIRMED solapadas ──
-- El API usa total = ocupadas + sum(available_units) por día; sin bajar inventario las tasas quedan muy bajas.
-- Ventana HIGH (~92%): noches CURRENT_DATE+5 … +19 → 8 estándar + 3 suite; inventario estándar 0, suite 1.
UPDATE catalog.inventory_calendar
SET available_units = 0, updated_at = now()
WHERE room_type_id = '60000000-0000-0000-0000-000000000001'
  AND day BETWEEN (CURRENT_DATE + 5) AND (CURRENT_DATE + 19);

UPDATE catalog.inventory_calendar
SET available_units = 1, updated_at = now()
WHERE room_type_id = '60000000-0000-0000-0000-000000000002'
  AND day BETWEEN (CURRENT_DATE + 5) AND (CURRENT_DATE + 19);

-- Ventana MEDIUM (~58%): noches +25 … +44 → 5 estándar + 2 suite; inventario estándar 3, suite 2.
UPDATE catalog.inventory_calendar
SET available_units = 3, updated_at = now()
WHERE room_type_id = '60000000-0000-0000-0000-000000000001'
  AND day BETWEEN (CURRENT_DATE + 25) AND (CURRENT_DATE + 44);

UPDATE catalog.inventory_calendar
SET available_units = 2, updated_at = now()
WHERE room_type_id = '60000000-0000-0000-0000-000000000002'
  AND day BETWEEN (CURRENT_DATE + 25) AND (CURRENT_DATE + 44);

-- Ventana LOW (~14%): inventario “abierto” y pocas reservas solapadas (+55 … +61).
UPDATE catalog.inventory_calendar
SET available_units = 8, updated_at = now()
WHERE room_type_id = '60000000-0000-0000-0000-000000000001'
  AND day BETWEEN (CURRENT_DATE + 50) AND (CURRENT_DATE + 89);

UPDATE catalog.inventory_calendar
SET available_units = 4, updated_at = now()
WHERE room_type_id = '60000000-0000-0000-0000-000000000002'
  AND day BETWEEN (CURRENT_DATE + 50) AND (CURRENT_DATE + 89);

-- Reservas demo ocupación (CONFIRMED, Cadena del Sol / Cancún). IDs UUID válidos f00d1001…
INSERT INTO booking.booking (
  id, user_id, status, checkin, checkout, total_amount, currency_code,
  property_id, room_type_id, rate_plan_id, unit_price,
  policy_type_applied, policy_hours_limit_applied, policy_refund_percent_applied,
  ...
  ('f00d1001-0000-4000-8000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'CONFIRMED', CURRENT_DATE + 5, CURRENT_DATE + 20, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-000000000002', 'a0000000-0000-0000-0000-000000000002', 'CONFIRMED', CURRENT_DATE + 5, CURRENT_DATE + 20, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-000000000003', 'a0000000-0000-0000-0000-000000000003', 'CONFIRMED', CURRENT_DATE + 5, CURRENT_DATE + 20, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 1),
  ('f00d1001-0000-4000-8000-000000000004', 'a0000000-0000-0000-0000-000000000004', 'CONFIRMED', CURRENT_DATE + 5, CURRENT_DATE + 20, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-000000000005', 'a0000000-0000-0000-0000-000000000005', 'CONFIRMED', CURRENT_DATE + 5, CURRENT_DATE + 20, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-000000000006', 'a0000000-0000-0000-0000-000000000001', 'CONFIRMED', CURRENT_DATE + 5, CURRENT_DATE + 20, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-000000000007', 'a0000000-0000-0000-0000-000000000002', 'CONFIRMED', CURRENT_DATE + 5, CURRENT_DATE + 20, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-000000000008', 'a0000000-0000-0000-0000-000000000003', 'CONFIRMED', CURRENT_DATE + 5, CURRENT_DATE + 20, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-000000000009', 'a0000000-0000-0000-0000-000000000001', 'CONFIRMED', CURRENT_DATE + 5, CURRENT_DATE + 20, 560.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000002', '70000000-0000-0000-0000-000000000002', 280.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-00000000000a', 'a0000000-0000-0000-0000-000000000002', 'CONFIRMED', CURRENT_DATE + 5, CURRENT_DATE + 20, 560.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000002', '70000000-0000-0000-0000-000000000002', 280.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-00000000000b', 'a0000000-0000-0000-0000-000000000004', 'CONFIRMED', CURRENT_DATE + 5, CURRENT_DATE + 20, 560.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000002', '70000000-0000-0000-0000-000000000002', 280.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-00000000000c', 'a0000000-0000-0000-0000-000000000001', 'CONFIRMED', CURRENT_DATE + 28, CURRENT_DATE + 45, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-00000000000d', 'a0000000-0000-0000-0000-000000000002', 'CONFIRMED', CURRENT_DATE + 28, CURRENT_DATE + 45, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-00000000000e', 'a0000000-0000-0000-0000-000000000003', 'CONFIRMED', CURRENT_DATE + 28, CURRENT_DATE + 45, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-00000000000f', 'a0000000-0000-0000-0000-000000000004', 'CONFIRMED', CURRENT_DATE + 28, CURRENT_DATE + 45, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-000000000010', 'a0000000-0000-0000-0000-000000000005', 'CONFIRMED', CURRENT_DATE + 28, CURRENT_DATE + 45, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-000000000011', 'a0000000-0000-0000-0000-000000000001', 'CONFIRMED', CURRENT_DATE + 28, CURRENT_DATE + 45, 560.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000002', '70000000-0000-0000-0000-000000000002', 280.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-000000000012', 'a0000000-0000-0000-0000-000000000002', 'CONFIRMED', CURRENT_DATE + 28, CURRENT_DATE + 45, 560.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000002', '70000000-0000-0000-0000-000000000002', 280.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-000000000013', 'a0000000-0000-0000-0000-000000000001', 'CONFIRMED', CURRENT_DATE + 55, CURRENT_DATE + 62, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 2),
  ('f00d1001-0000-4000-8000-000000000014', 'a0000000-0000-0000-0000-000000000002', 'CONFIRMED', CURRENT_DATE + 55, CURRENT_DATE + 62, 360.00, 'USD', '30000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000001', 120.00, 'FULL', 48, 100, TRUE, 2)
ON CONFLICT (id) DO NOTHING;

INSERT INTO booking.booking_status_history (id, booking_id, from_status, to_status, changed_by) VALUES
  ('f00d2001-0000-4000-8000-000000000001', 'f00d1001-0000-4000-8000-000000000001', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-000000000002', 'f00d1001-0000-4000-8000-000000000002', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-000000000003', 'f00d1001-0000-4000-8000-000000000003', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-000000000004', 'f00d1001-0000-4000-8000-000000000004', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-000000000005', 'f00d1001-0000-4000-8000-000000000005', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-000000000006', 'f00d1001-0000-4000-8000-000000000006', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-000000000007', 'f00d1001-0000-4000-8000-000000000007', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-000000000008', 'f00d1001-0000-4000-8000-000000000008', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-000000000009', 'f00d1001-0000-4000-8000-000000000009', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-00000000000a', 'f00d1001-0000-4000-8000-00000000000a', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-00000000000b', 'f00d1001-0000-4000-8000-00000000000b', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-00000000000c', 'f00d1001-0000-4000-8000-00000000000c', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-00000000000d', 'f00d1001-0000-4000-8000-00000000000d', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-00000000000e', 'f00d1001-0000-4000-8000-00000000000e', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-00000000000f', 'f00d1001-0000-4000-8000-00000000000f', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-000000000010', 'f00d1001-0000-4000-8000-000000000010', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-000000000011', 'f00d1001-0000-4000-8000-000000000011', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-000000000012', 'f00d1001-0000-4000-8000-000000000012', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-000000000013', 'f00d1001-0000-4000-8000-000000000013', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001'),
  ('f00d2001-0000-4000-8000-000000000014', 'f00d1001-0000-4000-8000-000000000014', NULL, 'CONFIRMED', 'b0000000-0000-0000-0000-000000000001')
ON CONFLICT (id) DO NOTHING;
