...
class GetHotelRevenueReportUseCase:
    """Revenue report by hotel and date range vs equivalent prior period."""
    ...
    async def execute(
        ...
        *,
        ...
        # Período anterior equivalente: misma duración, ventana inmediatamente previa.
        ...
        total_aggregated_revenue = round(
            sum(float(item.total_revenue) for item in by_room_type), 4
        )
