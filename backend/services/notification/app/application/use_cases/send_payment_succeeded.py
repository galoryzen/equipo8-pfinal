...
from contracts.events.payment import PaymentSucceededPayload

from app.adapters.outbound.email.templates.payment_succeeded import (
    PaymentSucceededContext,
    render_payment_succeeded,
)
...
class SendPaymentSucceededEmailUseCase:
    def __init__(
        self,
    ...
    async def execute(self, envelope: DomainEventEnvelope) -> None:
        ...
        subject, text, html = render_payment_succeeded(
            PaymentSucceededContext(
