...
def get_admin_register_partner_use_case(session: AsyncSession) -> AdminRegisterPartnerUserUseCase:
    return AdminRegisterPartnerUserUseCase(get_user_repository(session))
